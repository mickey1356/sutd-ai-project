...
function DashboardCard13({ firebaseData, date }) {
  ...
  const  sentiments= [
    {
      id: '1',
      sentiment: dayData['sentiments'].neg_sen1,
    },
    {
      id: '2',
      sentiment: dayData['sentiments'].neg_sen2,
    },
    {
      id: '3',
      sentiment: dayData['sentiments'].neg_sen3,
    },
  ...
  return (
    <div className="col-span-full xl:col-span-6 bg-grayshadow-lg rounded-sm border border-gray-200">
      <header className="px-5 py-4 border-b border-gray-100">
        <h2 className="font-semibold text-gray-200">Most Negative Sentiments</h2>
      </header>
      <div className="p-3">
            ...
            <tbody className="text-sm divide-y divide-gray-100">
              {
                sentiments.map(entry => {
                  return (
                    <tr key={entry.id}>
                      <td className="p-2">
                        <p className="text-left font-medium line-clamp-6 text-red-500">{entry.sentiment}</p>
                      </td>
                    </tr>
                  )
                })
