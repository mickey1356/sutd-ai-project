...
function FilterButton() {
  ...
  return (
    <div className="relative inline-flex">
      <button
        ref={trigger}
        className="btn bg-black border-gray-200 hover:border-gray-300 text-gray-500 hover:text-gray-600"
        aria-haspopup="true"
      ...
      <Transition
        show={dropdownOpen}
        tag="div"
        className="origin-top-right z-10 absolute top-full left-0 right-auto md:left-auto md:right-0 min-w-56 bg-black border border-gray-200 pt-1.5 rounded shadow-lg overflow-hidden mt-1"
        ...
        <div ref={dropdown}>
          ...
          <div className="py-2 px-3 border-t border-gray-200 bg-gray-50">
            <ul className="flex items-center justify-between">
              <li>
                <button className="btn-xs bg-black border-gray-200 hover:border-gray-300 text-gray-500 hover:text-gray-600">Clear</button>
              </li>
              <li>
