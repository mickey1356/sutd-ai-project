...
function DateSelect() {
  ...
  return (
    <div className="relative">
      <button
        ref={trigger}
        className="btn justify-between min-w-44 bg-black border-gray-200 hover:border-gray-300 text-gray-500 hover:text-gray-600"
      ...
      <Transition
        show={dropdownOpen}
        tag="div"
        className="z-10 absolute top-full right-0 w-full bg-black border border-gray-200 py-1.5 rounded shadow-lg overflow-hidden mt-1"
