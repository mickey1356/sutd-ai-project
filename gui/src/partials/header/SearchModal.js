          ...
          <div className="py-4 px-2" onFocus={() => setSearchOpen(true)} onBlur={() => setSearchOpen(false)}>
            ...
            <div className="mb-3 last:mb-0">
              ...
              <ul className="text-sm">
                <li>
                  <Link
                    className="flex items-center p-2 text-gray-200 hover:text-white hover:bg-indigo-500 rounded group"
                    to="#0"
              ...
              <ul className="text-sm">
                <li>
                  ...
                  >
                    ...
                    <span><span className="font-medium text-gray-200 group-hover:text-white">Messages</span> - Conversation / … / Mike Mills</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span><span className="font-medium text-gray-200 group-hover:text-white">Messages</span> - Conversation / … / Eva Patrick</span>
                  </Link>
                </li>
              </ul>
            </div>
